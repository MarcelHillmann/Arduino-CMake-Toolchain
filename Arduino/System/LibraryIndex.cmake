...
function(IndexArduinoLibraries namespace)
    message(VERBOSE "IndexArduinoLibraries: namespace: ${namespace}")
    ...
    message(VERBOSE "IndexArduinoLibraries: search_paths '${search_paths}'")
    if (search_paths STREQUAL "")
        ...
        message(VERBOSE "IndexArduinoLibraries: new search_paths '${search_paths}'")
    endif ()
    ...
    foreach (_root_path IN LISTS search_paths)
        message(VERBOSE "IndexArduinoLibraries: _root_path '${_root_path}'")
